...
[How to manually configure SSL using cert manager in Bold BI Kubernetes deployment?](https://github.com/boldbi/boldbi-server-in-kubernetes/blob/main//docs/FAQ/how-to-manually-configure-ssl-using-cert-manager-in-bold-bi-kubernetes-deployment.md)
