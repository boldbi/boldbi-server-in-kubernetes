...
You can download the upgrade script from this [link](https://raw.githubusercontent.com/boldbi/boldbi-server-in-kubernetes/v7.2.8/upgrade/7-2_upgrade.sh) or use the below command.

```sh
curl -o upgrade.sh https://raw.githubusercontent.com/boldbi/boldbi-server-in-kubernetes/v7.2.8/upgrade/7-2_upgrade.sh
```
